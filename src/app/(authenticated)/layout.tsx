...
export default function AuthenticatedLayout({
  ...
  return (
    <>
      <main className="flex-auto overflow-y-auto min-h-px" aria-label="Authenticated layout">
        <SessionProvider>
      ...
      <div className="dock justify-center static">
        <Link href="/setup" className={pathname.startsWith('/setup') ? `dock-active` : ''}>
        ...
        <Link href="/library" className={pathname.startsWith('/library') ? `dock-active` : ''}>
        ...
        <Link href="/playlists" className={pathname.startsWith('/playlists') ? `dock-active` : ''}>
          ...
          <span className="dock-label">Playlists</span>
        </Link>
      </div>
